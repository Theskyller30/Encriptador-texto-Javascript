...
function resultadoEncriptar() {
    ...
    if (inputText.value.length == 0) {
        instruccion.style.display = "inline-flex"; //Ver la instrucción 
        mensaje.style.display = "none"; //Ocultalo
        inputText.focus();
    } else {
        outputText.value = textoEncriptado; //Muestra el resultado
        inputText.value = ""; //Vaciar textarea
...
function encriptar(textoCapturado) {
    ...
    textoCapturado = textoCapturado.toLowerCase(); //Convierte el resultado
